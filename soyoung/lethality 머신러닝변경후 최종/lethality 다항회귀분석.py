# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 14:18:59 2024
...
ml_poly(df,col_ls)    
## 결정계수 -0.00482127248699582

#%%
# 노인 운전자 데이터 기준
old_df = df.loc[df['가해운전자 연령'] >= 65,:]

ml_poly(old_df,col_ls)
## 결정계수  -0.046130542838554334
...
ml_poly2(df,col_ls)    
## 결정계수 -0.0008734415470224022

#%%
# 노인 운전자 데이터 기준
old_df = df.loc[df['가해운전자 연령'] >= 65,:]

ml_poly2(old_df,col_ls)
## 결정계수  -0.01664420256516319
